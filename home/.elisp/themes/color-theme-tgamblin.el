;;;
;;; color-theme-tgamblin.el --- Todd's color theme
;;;

(defun color-theme-tgamblin ()
  "Color theme by todd, modified off of arjen"
  (interactive)
  (color-theme-install
   '(color-theme-tgamblin
     ...
     (default ((t (:background "black" :foreground "brightwhite"))))
     ...
     (fl-comment-face ((t (:foreground "Blue"))))
     ...
     (fl-type-face ((t (:foreground "blue"))))
     (font-lock-builtin-face ((t (:bold t :foreground "#0055ff"))))
     (font-lock-comment-face ((t (:foreground "#d7875f"))))
     (font-lock-constant-face ((t (:foreground "#dd00dd"))))
     (font-lock-doc-string-face ((t (:foreground "LightGreen"))))
     (font-lock-function-name-face ((t (:bold t :foreground "BrightBlue"))))
     (font-lock-keyword-face ((t (:bold t :foreground "#00d7ff"))))
     (font-lock-preprocessor-face ((t (:foreground "grey"))))
     (font-lock-reference-face ((t (:foreground "White"))))
     (font-lock-string-face ((t (:foreground "#99dd99"))))
     (font-lock-type-face ((t (:foreground "#00aa00"))))
     (font-lock-variable-name-face ((t (:foreground "#d7d700"))))
...
;     (modeline ((t (:background "Navy" :foreground "white" :box (:line-width 1 :style released-button)))))
;     (modeline-buffer-id ((t (:background "Navy" :foreground "white"))))
;     (modeline-mousable ((t (:background "Navy" :foreground "white"))))
;     (modeline-mousable-minor-mode ((t (:background "Navy" :foreground "white"))))
